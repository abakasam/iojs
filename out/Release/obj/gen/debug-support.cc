...
int v8dbg_type_ConstantPoolArray__CONSTANT_POOL_ARRAY_TYPE = CONSTANT_POOL_ARRAY_TYPE;
...
int v8dbg_parent_ConstantPoolArray__HeapObject = 0;
...
int v8dbg_class_Map__bit_field3__SMI = Map::kBitField3Offset;
